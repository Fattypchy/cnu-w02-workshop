# Week 2 workshop - Pair-programming and working with GitHub
...
- All students work from one laptop and pass it around when they switch roles. If you do this, make sure to disinfect your hands and the keyboard regularly.
...
| Command | Description |
|-|-|
| `git clone https://github.com/cnu-2021/cnu-w02-workshop-group-x-team-y.git` | Clones the GitHub repo in your home folder. |
| `cd cnu-w02-workshop-group-x-team-y` | Navigate to the newly created folder. |
...
- **Driver:** first of all, **share your screen** with your teammate(s), so that they can see what you do. When you code something, explain what you are doing out loud. Share your screen using your preferred method, as described earlier in the section "How does it work on a laptop?".
...
> - Launch a terminal, type `git clone https://github.com/cnu-2021/cnu-w02-workshop-group-x-team-y.git`, and press Enter.
...
> - Type `cd cnu-w02-workshop-group-x-team-y` and press Enter to navigate to the new folder.
...
Now, you are going to log your changes using git, and update the GitHub repo with your new code. There will be 3 steps to this process:
...
> - In your terminal, make sure you are still in the folder `cnu-w02-workshop-group-x-team-y`. If not (e.g. if you have opened a new terminal), navigate to it using `cd`.
...
**Note** for the new driver: if you decide to pass one laptop around to pair-program, you should still do the following from your *own* computer at least once. In future sessions, you will do this at the end of the session to ensure that all group members have access to the code you produced together.
...
> **Terminal commands:** to pull the changes, in the terminal, make sure you are in the folder `cnu-w02-workshop-group-x-team-y`; if not, navigate to it using `cd`. Then, type `git pull origin main` and press Enter.
